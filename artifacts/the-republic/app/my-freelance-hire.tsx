...
export default function MyFreelanceHireScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { backgroundColor: colors.background, borderBottomColor: colors.border, paddingTop: topPad + 8 }]}>
        ...
        <Text style={[styles.headerTitle, { color: colors.foreground }]}>Active Freelance Hire</Text>
        <View style={{ width: 36 }} />
      </View>
      <View style={styles.empty}>
        <Feather name="users" size={40} color={colors.mutedForeground} />
        <Text style={[styles.emptyTitle, { color: colors.foreground }]}>No active hires</Text>
        <Text style={[styles.emptySubText, { color: colors.mutedForeground }]}>
          Freelancers you've hired and are currently working with will appear here.
        </Text>
      </View>
    </View>
  );
