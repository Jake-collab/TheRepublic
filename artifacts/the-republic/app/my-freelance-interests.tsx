...
export default function MyFreelanceInterestsScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { backgroundColor: colors.background, borderBottomColor: colors.border, paddingTop: topPad + 8 }]}>
        ...
        <Text style={[styles.headerTitle, { color: colors.foreground }]}>Freelance Jobs Interested In</Text>
        <View style={{ width: 36 }} />
      </View>
      <View style={styles.empty}>
        <Feather name="heart" size={40} color={colors.mutedForeground} />
        <Text style={[styles.emptyTitle, { color: colors.foreground }]}>No interests yet</Text>
        <Text style={[styles.emptySubText, { color: colors.mutedForeground }]}>
          Freelance projects you've bid on or expressed interest in will appear here.
        </Text>
      </View>
    </View>
  );
