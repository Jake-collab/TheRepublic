  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.empty}>
        ...
        <Text style={[styles.emptyTitle, { color: colors.foreground }]}>No active freelance requests</Text>
        <Text style={[styles.emptySubText, { color: colors.mutedForeground }]}>
          Freelance projects you've posted as a client, currently accepting bids, will appear here.
        </Text>
      </View>
    </View>
  );
