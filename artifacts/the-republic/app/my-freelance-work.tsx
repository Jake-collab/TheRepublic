...
export default function MyFreelanceWorkScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { backgroundColor: colors.background, borderBottomColor: colors.border, paddingTop: topPad + 8 }]}>
        ...
        <Text style={[styles.headerTitle, { color: colors.foreground }]}>Active Freelance Work</Text>
        <View style={{ width: 36 }} />
      </View>
      <View style={styles.empty}>
        <Feather name="zap" size={40} color={colors.mutedForeground} />
        <Text style={[styles.emptyTitle, { color: colors.foreground }]}>No active freelance work</Text>
        <Text style={[styles.emptySubText, { color: colors.mutedForeground }]}>
          Freelance projects where your bid was accepted and work is in progress will appear here.
        </Text>
      </View>
    </View>
  );
