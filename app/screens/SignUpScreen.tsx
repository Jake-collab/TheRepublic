...
type SignUpScreenProps = { navigation: NativeStackNavigationProp<any>; };
    ...
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.content}>
        ...
        <View style={styles.form}>
          ...
          <Input label="Password" value={password} onChangeText={setPassword} placeholder="Create password" secureTextEntry />
          <Input label="Confirm" value={confirmPassword} onChangeText={setConfirmPassword} placeholder="Confirm password" secureTextEntry />
